...
export default function ChatboxMobileUI() {
  ...
  const handleSend = async () => {
    ...
    setMessages((prev) => [...prev, { role: 'user', text: queryRef.current }]);
    ...
    <>
      <div className=" bg-gray-50 flex flex-col justify-end">
        ...
        >
          ...
          {loading && (
            <div className="mr-auto bg-gray-200 text-gray-600 px-4 py-3 rounded-2xl max-w-[80%] shadow-sm flex gap-2">
